...
-(void)tapThemeButton:(UIButton*)button
{
    ...
    [wonderlandViewController setSelectedTheme:[[themeFactory themeArray] objectAtIndex:selectedIndex]];//加载被选主题
    [[RootViewController sharedRootViewController] pushViewController:wonderlandViewController];//贴纸乐园被加载
}
...
//    pageControl.backgroundColor = [UIColor blackColor];//调试代码
...
- (void)viewDidUnload {
    [self setBackViewController:nil];
    [super viewDidUnload];
}
@end
